...
public class Ejercicio5_CiclosJOptionPane {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Se ha generado un número aleatorio entre 0 y 100.");
        
        do{
            contador ++;
            
            String input = JOptionPane.showInputDialog("¿Cuál número es?");
